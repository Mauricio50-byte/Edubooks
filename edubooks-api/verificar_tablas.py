    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            tablas_esperadas = [
                ...
                'usuarios_accesorecurso',
                'usuarios_administrador',
                'usuarios_configuracionauditoria',
                'usuarios_configuracionnotificacion',
                'usuarios_docente',
                'usuarios_estudiante',
                'usuarios_invitacionregistro',
                'usuarios_notificacion',
                'usuarios_plantillanotificacion',
                'usuarios_registroauditoria',
                'usuarios_sesionusuario',
                'usuarios_usuario'
            ]
